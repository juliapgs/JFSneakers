...
public class PedidoResource {
    ...
    @GET
    @Path("/formaPagamento/{formaPagamento}")
    public Response findByFormaPagamento(@PathParam("formaPagamento") FormaPagamento formaPagamento) {
        List<PedidoResponseDTO> pedidos = service.findByFormaPagamento(formaPagamento);
        return Response.ok(pedidos).build();
    }
}
